...
function task5()
{
    ...
    function messagePalindrom($incomString)
    {
        if (checkPalindrom($incomString) === true) {
            echo 'Палиндром – строка, одинаково читающаяся в обоих направлениях<br>';
        } else {
